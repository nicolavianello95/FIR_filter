...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix fir_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix fir_postRoute -outDir timingReports
...
report_power -rail_analysis_format VS -outfile .//post_pr_power_sa_adv.rpt
